...
public class AppDesignerWikiSpaceResource  extends EntityServerResource<AppDesignerWikiSpace > {

    private String listId;
    private DesignerApplication app;

    public AppDesignerWikiSpaceResource() {
    ...
    @Override
    public AppDesignerWikiSpace getEntity() {
        return null;// app.getRepository().getById(TodoList.class, listId);
    }
    
    /*@Override
    public AppDesignerWikiSpace getEntity(String installation) {
