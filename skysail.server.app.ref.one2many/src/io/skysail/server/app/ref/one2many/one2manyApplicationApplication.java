...
public class one2manyApplicationApplication extends one2manyApplicationApplicationGen implements ApplicationProvider, MenuItemProvider {

    public  one2manyApplicationApplication() {
        super("one2manyApplication", new ApiVersion(1), Arrays.asList());
